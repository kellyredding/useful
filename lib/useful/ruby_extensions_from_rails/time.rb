...
require 'useful/ruby_extensions_from_rails/object' unless Object.new.respond_to?(:acts_like?)
require 'useful/ruby_extensions_from_rails/duration'
require 'useful/ruby_extensions_from_rails/numeric'

module Useful::RubyExtensionsFromRails::Time
